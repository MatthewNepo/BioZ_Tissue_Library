function Data = ExVivoData(substance,date)
    ...
    date = num2str(date);
    Substance = zeros(201,6);
    Substance_comp = zeros(201,6);
    ...
    Substance_avgs = [Substance_S1_avg;Substance_S2_avg];
    ...
    Substance_comp_avgs = [Substance_comp_S1_avg;Substance_comp_S2_avg];
